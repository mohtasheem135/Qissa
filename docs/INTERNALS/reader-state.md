...
| `qissa:last-read` | `{ storyId, partNumber, updatedAt }` | `savePartProgress()` | [StoryBrowser](../../components/shared/StoryBrowser.tsx) (Resume badge), [InstallPrompt](../../components/shared/InstallPrompt.tsx) (gate) |
