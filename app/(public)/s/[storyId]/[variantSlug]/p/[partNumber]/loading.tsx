...
/**
 * Reader skeleton. We render a neutral background — the persisted theme
 * is in localStorage and would require a client component to read, which
 * defeats the point of a fast static fallback.
 */
